        ...
        <div className="reg-left-panel fade-in" style={s.leftPanel}>
          ...
          <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <div className="reg-steps-wrap" style={s.stepsWrap}>
              {[
                ...
                <div key={st.n} style={s.stepRow}>
                  ...
                  <div>
                    <div style={{ ...s.stepLabel, color: step >= st.n ? "#e2e8f0" : "#334155" }}>{st.label}</div>
                    <div style={s.stepSub}>{st.sub}</div>
                  </div>
                  {st.n < 2 && (
                    <div style={{ ...s.stepLine, background: step > st.n ? "rgba(99,102,241,0.5)" : "rgba(255,255,255,0.05)" }} />
                  )}
                </div>
              ))}
            </div>
            <div className="reg-security" style={s.securityNote}>
              ...
              <span style={{ color: "#334155", fontSize: 13, fontFamily: "'DM Sans', sans-serif" }}>
            ...
            {step === 1 && (
              <div className="fade-in">
                <div style={{ textAlign: "center", marginBottom: 28 }}>
                  <h2 className="reg-card-title" style={s.cardTitle}>Create Account</h2>
                ...
                <p style={s.footer}>
                  Already registered?{" "}
                  <a href="/login" style={s.footerLink}>Login here</a>
                </p>
              </div>
            )}
              ...
              <div className="fade-in">
                <div style={{ textAlign: "center", marginBottom: 20 }}>
                  <div style={s.cardBadge}>
                    <div
                      style={{ width: 7, height: 7, borderRadius: "50%", background: sc, boxShadow: `0 0 6px ${sc}` }}
                      className={status === "idle" || status === "scanning" ? "pulse" : ""}
                    />
                ...
                <div style={{ marginBottom: 16 }}>
                  <div style={{ ...s.cameraWrap, borderColor: `${sc}40`, boxShadow: `0 0 30px ${sc}15` }}>
                    {["tl", "tr", "bl", "br"].map((c) => (
                      <div key={c} className={`corner ${c}`} style={{ "--cc": sc }} />
                    ))}
                    ...
                    {status === "success" && (
                      <div style={s.successOverlay} className="success-pop">
                        <div style={s.successCircle}>
                          <svg width="36" height="36" viewBox="0 0 24 24" fill="none" stroke="#34d399" strokeWidth="2.5" strokeLinecap="round">
